<template>
	<view>
		<template v-if="loginStatus">
			<uni-list-item title="账号安全"></uni-list-item>
		...
		<uni-list-item v-if="loginStatus" title="意见反馈" @click="open('user-feedback')">
		</uni-list-item>
...
<script>
	...
	erxport default{
		...
		//通过辅助函数，从Vuex解构得到计算机属性loginStatus登陆状态
		computed:{
			...mapState({
